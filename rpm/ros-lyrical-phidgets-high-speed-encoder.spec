...
%global pkg_name phidgets_high_speed_encoder
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-phidgets-high-speed-encoder
Version:        2.4.0
Release:        3%{?dist}
...
%changelog
* Wed Apr 29 2026 Martin Günther <martin.guenther@dfki.de> - 2.4.0-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Martin Günther <martin.guenther@dfki.de> - 2.4.0-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Martin Günther <martin.guenther@dfki.de> - 2.4.0-1
- Autogenerated by Bloom
